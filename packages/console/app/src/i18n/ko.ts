...
export const dict = {
  ...
  "notFound.logoLightAlt": "openbmw 밝은 로고",
  "notFound.logoDarkAlt": "openbmw 어두운 로고",
  ...
  "temp.logoLightAlt": "openbmw 밝은 로고",
  "temp.logoDarkAlt": "openbmw 어두운 로고",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go 모델을 사용하려면 openbmw 설정에서 "OpenCode Go"를 공급자로 선택하세요.',
