...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | openbmw",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo openbmw",
  "notFound.logoDarkAlt": "ciemne logo openbmw",
  ...
  "temp.title": "openbmw | Agent AI do kodowania zbudowany dla terminala",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez openbmw",
  ...
  "temp.logoLightAlt": "jasne logo openbmw",
  "temp.logoDarkAlt": "ciemne logo openbmw",
  ...
  "workspace.newUser.step.login.after": "i wybierz openbmw",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom openbmw i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług openbmw.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy openbmw",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "OpenCode Go" jako dostawcę w konfiguracji openbmw, aby używać modeli Go.',
