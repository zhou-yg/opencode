...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | openbmw",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "openbmw logo lys",
  "notFound.logoDarkAlt": "openbmw logo mørk",
  ...
  "temp.title": "openbmw | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av openbmw",
  ...
  "temp.screenshot.caption": "openbmw TUI med tokyonight-tema",
  "temp.screenshot.alt": "openbmw TUI med tokyonight-tema",
  "temp.logoLightAlt": "openbmw logo lys",
  "temp.logoDarkAlt": "openbmw logo mørk",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med openbmw når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg openbmw",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start openbmw og kjør",
  ...
  "workspace.keys.empty": "Opprett en openbmw Gateway API-nøkkel",
