...
export const dict = {
  ...
  "notFound.title": "غير موجود | openbmw",
  "notFound.heading": "404 - الصفحة غير موجودة",
  "notFound.home": "الرئيسية",
  "notFound.docs": "الوثائق",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "شعار openbmw الفاتح",
  "notFound.logoDarkAlt": "شعار openbmw الداكن",
  ...
  "temp.title": "openbmw | وكيل برمجة بالذكاء الاصطناعي مبني للطرفية",
  ...
  "temp.feature.zen.afterLink": "مقدمة من openbmw",
  ...
  "temp.logoLightAlt": "شعار openbmw الفاتح",
  "temp.logoDarkAlt": "شعار openbmw الداكن",
  ...
  "workspace.newUser.feature.lockin.body":
    "استخدم Zen مع أي وكيل برمجة، واستمر في استخدام موفرين آخرين مع openbmw وقتما تشاء.",
  ...
  "workspace.newUser.step.login.after": "واختر openbmw",
  "workspace.newUser.step.pasteKey": "الصق مفتاح API الخاص بك",
  "workspace.newUser.step.models.before": "ابدأ openbmw ثم نفّذ",
  ...
  "workspace.keys.subtitle": "إدارة مفاتيح API الخاصة بك للوصول إلى خدمات openbmw.",
  "workspace.keys.create": "إنشاء مفتاح API",
  "workspace.keys.placeholder": "أدخل اسم المفتاح",
  "workspace.keys.empty": "أنشئ مفتاح API لبوابة openbmw",
  ...
  "workspace.lite.subscription.selectProvider":
    'اختر "OpenCode Go" كمزود في إعدادات openbmw الخاصة بك لاستخدام نماذج Go.',
