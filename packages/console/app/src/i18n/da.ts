...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | openbmw",
  ...
  "temp.title": "openbmw | AI-kodningsagent bygget til terminalen",
  ...
  "temp.feature.zen.afterLink": "leveret af openbmw",
  ...
  "temp.screenshot.caption": "openbmw TUI med tokyonight-temaet",
  "temp.screenshot.alt": "openbmw TUI med tokyonight-temaet",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med openbmw, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg openbmw",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start openbmw og kør",
  ...
  "workspace.keys.empty": "Opret en openbmw Gateway API-nøgle",
