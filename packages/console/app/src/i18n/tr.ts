...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | openbmw",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "openbmw açık logo",
  "notFound.logoDarkAlt": "openbmw koyu logo",
  ...
  "temp.title": "openbmw | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "openbmw tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "openbmw TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı openbmw TUI",
  "temp.logoLightAlt": "openbmw açık logo",
  "temp.logoDarkAlt": "openbmw koyu logo",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman openbmw ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve openbmw seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "openbmw'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "openbmw hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir openbmw Gateway API anahtarı oluşturun",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için openbmw yapılandırmanızda "OpenCode Go"\'yu sağlayıcı olarak seçin.',
