export const dict = {
  ...
  "notFound.title": "Not Found | openbmw",
  "notFound.heading": "404 - Page Not Found",
  "notFound.home": "Home",
  "notFound.docs": "Docs",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "openbmw logo light",
  "notFound.logoDarkAlt": "openbmw logo dark",
  ...
  "temp.title": "openbmw | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by openbmw",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "openbmw TUI with the tokyonight theme",
  "temp.screenshot.alt": "openbmw TUI with tokyonight theme",
  "temp.logoLightAlt": "openbmw logo light",
  "temp.logoDarkAlt": "openbmw logo dark",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with openbmw whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select openbmw",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start openbmw and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing openbmw services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an openbmw Gateway API key",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "OpenCode Go" as the provider in your openbmw configuration to use Go models.',
