...
export const dict = {
  ...
  "notFound.title": "No encontrado | openbmw",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "openbmw logo claro",
  "notFound.logoDarkAlt": "openbmw logo oscuro",
  ...
  "temp.title": "openbmw | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por openbmw",
  ...
  "temp.screenshot.caption": "openbmw TUI con el tema tokyonight",
  "temp.screenshot.alt": "openbmw TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de openbmw claro",
  "temp.logoDarkAlt": "logo de openbmw oscuro",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con openbmw cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona openbmw",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia openbmw y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de openbmw.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de openbmw Gateway",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "OpenCode Go" como proveedor en tu configuración de openbmw para usar los modelos Go.',
