        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/openbmw")}>
                <code>
                  brew install <strong>anomalyco/tap/openbmw</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S openbmw")}>
                <code>
                  paru -S <strong>openbmw</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
