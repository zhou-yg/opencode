---
title: ACP-støtte
description: Bruk openbmw i en hvilken som helst ACP-kompatibel editor.
---
...
For å bruke OpenCode via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `openbmw acp`.
