...
OpenCode integreres med VS Code, Cursor eller en hvilken som helst IDE som støtter en terminal. Bare kjør `openbmw` i terminalen for å komme i gang.
...
3. Kjør `openbmw` - utvidelsen installeres automatisk
...
- Sørg for at du kjører `openbmw` i den integrerte terminalen.
