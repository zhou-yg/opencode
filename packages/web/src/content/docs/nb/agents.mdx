...
- Globalt: `~/.config/openbmw/agents/`
- Per prosjekt: `.openbmw/agents/`
...
Modellen ID i OpenCode-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [OpenCode Zen](/docs/zen), vil du bruke `openbmw/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `openbmw models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/openbmw).
:::
