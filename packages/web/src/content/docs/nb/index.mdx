...
- **Bruke Homebrew på macOS og Linux**
  ...
  > Vi anbefaler å bruke OpenCode-tappen for de mest oppdaterte utgivelsene. Den offisielle `brew install openbmw`-formelen vedlikeholdes av Homebrew-teamet og oppdateres sjeldnere.
...
Du kan også hente binæren fra [Releases](https://github.com/anomalyco/openbmw/releases).
