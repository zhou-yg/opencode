...
openbmw søker etter disse stedene:

- Prosjektkonfigurasjon: `.openbmw/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/openbmw/skills/<name>/SKILL.md`
...
For prosjektlokale stier går openbmw opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.openbmw/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/openbmw/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.openbmw/skills/git-release/SKILL.md` slik:
...
openbmw viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
