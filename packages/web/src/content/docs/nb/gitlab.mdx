---
title: GitLab
description: Bruk openbmw i GitLab-problemer og Merge Requests.
---
...
Her bruker vi en fellesskapsskapt CI/CD-komponent for OpenCode — [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw).
...
For flere inndata og brukstilfeller [sjekk ut dokumentene](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw) for denne komponenten.
