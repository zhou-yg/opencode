...
Du kan også sjekke ut [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) og [opencode\.cafe](https://opencode\.cafe), et fellesskap som samler økosystemet og fellesskapet.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Bakgrunnsagenter, forhåndsbygde LSP/AST/MCP verktøy, kurerte agenter, Claude Code-kompatibel                  |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktiv plangjennomgang med visuell merknad og privat/offline deling                                       |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge OpenCode-plugins                                    |
