...
ในการใช้ OpenCode ผ่าน ACP ให้กำหนดค่าโปรแกรมแก้ไขของคุณให้รันคำสั่ง `openbmw acp`
...
คุณสามารถใช้ CodeCompanion เพื่อใช้ openbmw เป็น ACP agent สำหรับแชท
...
openbmw ทำงานผ่าน ACP เหมือนกับใน terminal และรองรับฟีเจอร์ทั้งหมด:
