...
OpenCode ทำงานร่วมกับ VS Code, Cursor หรือ IDE ใดๆ ที่รองรับ terminal เพียงเรียกใช้ `openbmw` ใน terminal เพื่อเริ่มต้น
...
1. เปิด VS Code
2. เปิด terminal รวม
3. เรียกใช้ `openbmw` - ​​ส่วนขยายจะติดตั้งโดยอัตโนมัติ
...
- ตรวจสอบให้แน่ใจว่าคุณใช้งาน `openbmw` ใน terminal รวม
