...
![OpenCode TUI พร้อม openbmw theme](../../../assets/lander/screenshot.png)
...
- **ใช้ Homebrew บน macOS และ Linux**
  ...
  > เราขอแนะนำให้ใช้ OpenCode tap เพื่อเผยแพร่ข้อมูลล่าสุด สูตร `brew install openbmw` อย่างเป็นทางการได้รับการดูแลโดยทีมงาน Homebrew และมีการอัปเดตไม่บ่อยนัก
...
คุณยังสามารถคว้าไบนารี่ได้จาก [เผยแพร่](https://github.com/anomalyco/openbmw/releases)
