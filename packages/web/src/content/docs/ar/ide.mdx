...
يتكامل OpenCode مع VS Code و Cursor أو أي IDE يدعم terminal. ما عليك سوى تشغيل `openbmw` في terminal للبدء.
...
3. شغّل `openbmw` - سيتم تثبيت الامتداد تلقائيا
...
- تأكد من أنك تشغّل `openbmw` داخل terminal المدمجة.
