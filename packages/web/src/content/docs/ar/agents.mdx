...
- عام: `~/.config/openbmw/agents/`
- لكل مشروع: `.openbmw/agents/`
...
يستخدم معرّف النموذج في إعدادات OpenCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenCode Zen](/docs/zen)، فستستخدم `openbmw/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `openbmw models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/openbmw).
:::
