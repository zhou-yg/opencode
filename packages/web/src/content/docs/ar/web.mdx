...
:::tip[مستخدمو Windows]
لأفضل تجربة، شغّل `openbmw web` من [WSL](/docs/windows-wsl) بدلا من PowerShell. يضمن ذلك وصولا صحيحا إلى نظام الملفات وتكاملا أفضل مع terminal.
:::
...
اسم المستخدم الافتراضي هو `openbmw`، ويمكن تغييره عبر `OPENCODE_SERVER_USERNAME`.
