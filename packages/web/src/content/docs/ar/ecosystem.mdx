...
يمكنك أيضًا الاطلاع على [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) و [opencode.cafe](https://opencode.cafe)، وهو مجتمع يجمع النظام البيئي والمجتمع.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | وكلاء الخلفية، وأدوات LSP/AST/MCP المعدة مسبقًا، ووكلاء مختارون، متوافق مع Claude Code                         |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | مراجعة تفاعلية للخطة مع تعليقات توضيحية مرئية ومشاركة خاصة/بدون اتصال                                          |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | توسيع openbmw /commands إلى نظام تنسيق قوي مع تحكم دقيق في التدفق                                             |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | قالب لبناء إضافات OpenCode                                                |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | واجهة Neovim لـ openbmw - وكيل برمجة بالذكاء الاصطناعي يعتمد على الطرفية |
