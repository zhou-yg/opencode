...
أنشئ الملف `.openbmw/commands/test.md`:
...
- على مستوى النظام: `~/.config/openbmw/commands/`
- لكل مشروع: `.openbmw/commands/`
...
يتضمن openbmw عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).
