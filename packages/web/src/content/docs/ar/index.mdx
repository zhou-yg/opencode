...
![واجهة OpenCode في terminal مع سمة openbmw](../../../assets/lander/screenshot.png)
...
- **باستخدام Homebrew على macOS وLinux**
  ...
  > نوصي باستخدام tap الخاص بـ OpenCode للحصول على أحدث الإصدارات. صيغة `brew install openbmw` الرسمية تُدار بواسطة فريق Homebrew ويتم تحديثها بوتيرة أقل.
...
يمكنك أيضا تنزيل الملف التنفيذي من صفحة [Releases](https://github.com/anomalyco/openbmw/releases).
...
1. شغّل الأمر `/connect` في واجهة TUI، واختر openbmw، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/auth).
