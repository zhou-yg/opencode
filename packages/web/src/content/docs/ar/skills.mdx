...
- إعدادات المشروع: `.openbmw/skills/<name>/SKILL.md`
- إعدادات عامة: `~/.config/openbmw/skills/<name>/SKILL.md`
...
ويحمّل أي ملفات مطابقة لـ `skills/*/SKILL.md` داخل `.openbmw/` وأي ملفات مطابقة لـ `.claude/skills/*/SKILL.md` أو `.agents/skills/*/SKILL.md` على طول الطريق.

كما تُحمَّل التعريفات العامة أيضاً من `~/.config/openbmw/skills/*/SKILL.md` و `~/.claude/skills/*/SKILL.md` و `~/.agents/skills/*/SKILL.md`.
...
أنشئ `.openbmw/skills/git-release/SKILL.md` بهذا الشكل:
