...
description: عميل JavaScript آمن الأنواع لخادم openbmw.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

توفر SDK الخاصة بـ openbmw لـ JS/TS عميلا آمنا للأنواع للتفاعل مع الخادم.
استخدمها لبناء التكاملات والتحكم في openbmw برمجيا.
...
إذا كان لديك مثيل openbmw يعمل بالفعل، يمكنك إنشاء مثيل عميل للاتصال به:
