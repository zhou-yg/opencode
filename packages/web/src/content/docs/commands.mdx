...
Create `.openbmw/commands/test.md`:
...
openbmw includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
