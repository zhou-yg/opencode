---
title: TUI
description: Usando a interface de usuário de terminal openbmw.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O openbmw fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar openbmw inicia o TUI para o diretório atual.
...
Ao usar o TUI do openbmw, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao openbmw. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do openbmw. _Aliases_: `/quit`, `/q`
