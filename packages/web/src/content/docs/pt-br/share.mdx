---
title: Compartilhar
description: Compartilhe suas conversas do openbmw.
---

O recurso de compartilhamento do openbmw permite que você crie links públicos para suas conversas do openbmw, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o openbmw:
...
O openbmw suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o openbmw usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
[Saiba mais](/docs/enterprise) sobre como usar o openbmw em sua organização.
