...
Você também pode conferir [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) e [opencode.cafe](https://opencode.cafe), uma comunidade que agrega o ecossistema e a comunidade.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Agentes em segundo plano, ferramentas LSP/AST/MCP pré-construídas, agentes curados, compatível com Claude Code                 |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisão de plano interativa com anotação visual e compartilhamento privado/offline                                             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estenda openbmw /commands em um poderoso sistema de orquestração com controle de fluxo granular                               |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template para construir plugins do OpenCode                                     |
