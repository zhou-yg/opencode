...
Você pode adicionar comandos personalizados através da configuração do openbmw ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do openbmw:
...
- Global: `~/.config/openbmw/commands/`
- Por projeto: `.openbmw/commands/`
...
openbmw inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
