...
Također možete pogledati [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) i [opencode.cafe](https://opencode.cafe), zajednicu koja spaja ekosistem i zajednicu.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Pozadinski agenti, unapred izgrađeni LSP/AST/MCP alati, kurirani agenti, kompatibilni sa Claude Code          |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktivni pregled plana s vizualnim napomenama i privatnim/offline dijeljenjem                             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Proširite openbmw /komande u moćan sistem orkestracije sa granularnom kontrolom toka                         |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Predložak za izgradnju OpenCode dodataka                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend za openbmw - terminal baziran AI agent za kodiranje  |
