...
![OpenCode TUI sa openbmw temom](../../../assets/lander/screenshot.png)
Hajde da počnemo.
...
> Preporučujemo korištenje OpenCode tap za najnovija izdanja. Službenu formulu `brew install openbmw` održava Homebrew tim i ažurira se rjeđe.
...
Također možete preuzeti binarnu datoteku iz [Releases](https://github.com/anomalyco/openbmw/releases).
