...
1. **Pokrenite `openbmw web` u WSL terminalu** umjesto u PowerShell-u:
...
Pokretanje `openbmw web` iz WSL-a osigurava ispravan pristup fajl sistemu i terminalsku integraciju, a i dalje je dostupno iz Windows browsera.
...
- Vase OpenCode konfiguracije i sesije cuvaju se u WSL okruzenju na `~/.local/share/openbmw/`
