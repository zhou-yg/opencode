...
- Globalno: `~/.config/openbmw/agents/`
- Po projektu: `.openbmw/agents/`
...
ID modela u vašoj OpenCode konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [OpenCode Zen](/docs/zen), koristili biste `openbmw/gpt-5.1-codex` za GPT 5.1 Codex.
...
:::tip
Pokrenite `openbmw models` da vidite listu dostupnih modela.
:::
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/anomalyco/openbmw).
:::
