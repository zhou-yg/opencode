...
OpenCode se integriše sa VS kodom, Cursor-om ili bilo kojim IDE-om koji podržava terminal. Samo pokrenite `openbmw` u terminalu da započnete.
...
3. Pokrenite `openbmw` - ekstenzija se automatski instalira
...
- Uvjerite se da koristite `openbmw` u integriranom terminalu.
