...
- Konfiguracija projekta: `.openbmw/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/openbmw/skills/<name>/SKILL.md`
...
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.openbmw/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/openbmw/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.openbmw/skills/git-release/SKILL.md` ovako:
