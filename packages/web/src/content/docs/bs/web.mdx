...
Za najbolje iskustvo, pokrenite `openbmw web` iz [WSL](/docs/windows-wsl) umjesto PowerShell-a. Ovo osigurava pravilan pristup sistemu datoteka i integraciju terminala.
:::
...
Korisničko ime podrazumevano je `openbmw`, ali se može promeniti sa `OPENCODE_SERVER_USERNAME`.
