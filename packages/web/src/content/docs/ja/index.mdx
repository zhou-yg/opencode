...
- **macOS および Linux での Homebrew の使用**
  ...
  > 最新のリリースには OpenCode タップを使用することをお勧めします。公式の `brew install openbmw` 式は Homebrew チームによって維持されており、更新頻度は低くなります。
...
[Releases](https://github.com/anomalyco/openbmw/releases).
...
1. TUI で `/connect` コマンドを実行し、openbmw を選択して、[opencode.ai/auth](https://opencode.ai/auth) で認証します。
