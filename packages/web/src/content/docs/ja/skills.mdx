...
- プロジェクト設定: `.openbmw/skills/<name>/SKILL.md`
- グローバル設定: `~/.config/openbmw/skills/<name>/SKILL.md`
...
途中で、一致する `skills/*/SKILL.md` を `.openbmw/` に読み込み、一致する `.claude/skills/*/SKILL.md` または `.agents/skills/*/SKILL.md` を読み込みます。

グローバル定義は、`~/.config/openbmw/skills/*/SKILL.md`、`~/.claude/skills/*/SKILL.md`、および `~/.agents/skills/*/SKILL.md` からもロードされます。
...
次のように `.openbmw/skills/git-release/SKILL.md` を作成します。
