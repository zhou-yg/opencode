...
OpenCode integrates with your GitHub workflow. Mention `/openbmw` or `/oc` in your comment, and OpenCode will execute tasks within your GitHub Actions runner.
...
| ----------------------------- | -------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `issue_comment`               | Comment on an issue or PR              | Mention `/openbmw` or `/oc` in your comment. OpenCode reads context and can create branches, open PRs, or reply. |
| `pull_request_review_comment` | Comment on specific code lines in a PR | Mention `/openbmw` or `/oc` while reviewing code. OpenCode receives file path, line numbers, and diff context.   |
