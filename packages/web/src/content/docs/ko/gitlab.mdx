...
여기서는 OpenCode용 커뮤니티 제작 CI/CD component인 [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw)를 사용합니다.
...
더 많은 입력값과 사용 사례는 이 component의 [docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw)에서 확인하세요.
