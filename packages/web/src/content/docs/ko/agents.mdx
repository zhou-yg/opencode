...
OpenCode config의 model ID는 `provider/model-id` 형식을 사용합니다. 예를 들어 [OpenCode Zen](/docs/zen)을 사용한다면 GPT 5.1 Codex에 `openbmw/gpt-5.1-codex`를 사용합니다.
...
:::tip
사용 가능한 model 목록은 `openbmw models` 명령으로 확인할 수 있습니다.
:::
...
:::tip
공유하고 싶은 agent가 있나요? [PR 제출하기](https://github.com/anomalyco/openbmw).
:::
