...
![openbmw TUI with the openbmw theme](../../../assets/lander/screenshot.png)
...
- **macOS/Linux에서 Homebrew 사용**
  ...
  > 최신 릴리스를 사용하려면 OpenCode tap 사용을 권장합니다. 공식 `brew install openbmw` formula는 Homebrew 팀이 관리하며 업데이트 주기가 더 깁니다.
...
[Releases](https://github.com/anomalyco/openbmw/releases)에서 바이너리를 직접 받아 설치할 수도 있습니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `openbmw`를 선택한 다음 [opencode.ai/auth](https://opencode.ai/auth)로 이동합니다.
