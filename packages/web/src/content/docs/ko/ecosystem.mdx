...
[awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw)와 [opencode\.cafe](https://opencode\.cafe)도 함께 확인해 보세요. ecosystem과 community 정보를 한곳에 모아볼 수 있습니다.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | background agent, 사전 구성된 LSP/AST/MCP tool, curated agent, Claude Code 호환성을 제공합니다. |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | 시각 주석과 private/offline 공유를 포함한 인터랙티브 계획 리뷰를 제공합니다.                    |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | 세밀한 flow control로 openbmw /commands를 강력한 orchestration 시스템으로 확장합니다.          |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | OpenCode plugin 개발을 위한 템플릿입니다.                              |
