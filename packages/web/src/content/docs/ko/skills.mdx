...
Agent Skill let openbmw discover reusable instruction from your repo 또는 홈 디렉토리.
...
- 프로젝트 구성: `.openbmw/skills/<name>/SKILL.md`
- 글로벌 구성: `~/.config/openbmw/skills/<name>/SKILL.md`
...
그것은 `skills/*/SKILL.md`에 있는 어떤 어울리는 `.openbmw/` 및 어떤 어울리는 `.claude/skills/*/SKILL.md` 또는 `.agents/skills/*/SKILL.md`를 방법 적재합니다.

세계적인 정의는 또한 `~/.config/openbmw/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` 및 `~/.agents/skills/*/SKILL.md`에서 적재됩니다.
...
이처럼 `.openbmw/skills/git-release/SKILL.md` 만들기:
