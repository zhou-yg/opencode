...
You can also check out [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) and [opencode.cafe](https://opencode.cafe), a community that aggregates the ecosystem and community.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Background agents, pre-built LSP/AST/MCP tools, curated agents, Claude Code compatible            |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interactive plan review with visual annotation and private/offline sharing                        |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend openbmw /commands into a powerful orchestration system with granular flow control         |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building OpenCode plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for openbmw - a terminal-based AI coding agent  |
