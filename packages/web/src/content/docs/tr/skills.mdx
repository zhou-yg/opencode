...
Ajan becerileri, openbmw'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
openbmw su konumlari tarar:

- Proje konfigurasyonu: `.openbmw/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/openbmw/skills/<name>/SKILL.md`
...
Proje yerel yollarinda openbmw, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.openbmw/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/openbmw/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.openbmw/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
openbmw, `skill` araci aciklamasinda mevcut becerileri listeler.
