...
- `.openbmw/plugins/` - Proje düzeyinde eklentiler
- `~/.config/openbmw/plugins/` - Genel eklentiler
...
**npm eklentileri** başlangıçta Bun kullanılarak otomatik olarak yüklenir. Paketler ve bağımlılıkları `~/.cache/openbmw/node_modules/`'da önbelleğe alınır.
...
3. Global eklenti dizini (`~/.config/openbmw/plugins/`)
4. Proje eklenti dizini (`.openbmw/plugins/`)
