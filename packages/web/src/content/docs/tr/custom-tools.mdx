---
title: Özel Araçlar
description: LLM'un openbmw'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. openbmw'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.openbmw/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/openbmw/tools/` içine yerleştirerek.
