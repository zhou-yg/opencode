...
`.openbmw/commands/test.md` oluştur:
...
openbmw işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

openbmw [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/openbmw/commands/`
- Proje başına: `.openbmw/commands/`
...
openbmw, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
