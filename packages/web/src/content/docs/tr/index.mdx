...
- **Homebrew'u macOS ve Linux'ta kullanma**
  ...
  > En güncel sürümler için OpenCode tap'ini kullanmanızı öneririz. Resmi `brew install openbmw` formülü Homebrew ekibi tarafından korunur ve daha sık güncellenir.
...
İkili dosyayı [Releases](https://github.com/anomalyco/openbmw/releases)'dan da alabilirsiniz.
