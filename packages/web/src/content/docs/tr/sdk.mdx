---
title: SDK
description: openbmw sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

openbmw JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
openbmw'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Halihazırda çalışan bir openbmw örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
