...
Ayrıca ekosistemi ve topluluğu bir araya getiren [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) ve [opencode\.cafe](https://opencode\.cafe) adreslerine de göz atabilirsiniz.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Arka plan aracıları, hazır LSP/AST/MCP araçları, seçilmiş aracılar, Claude Code uyumlu                                        |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Görsel not alma ve özel/çevrimdışı paylaşım ile etkileşimli plan incelemesi                                                   |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | openbmw /commands komutlarını, ayrıntılı akış kontrolü ile güçlü bir orkestrasyon sistemine genişletin                       |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | OpenCode eklentileri oluşturmak için şablon                                     |
| [opencode\.nvim](https://github.com/sudo-tee/opencode\.nvim)                                 | openbmw için Neovim ön yüzü - terminal tabanlı bir yapay zeka kodlama aracısı  |
