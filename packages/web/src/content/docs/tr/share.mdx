---
title: Paylasim
description: openbmw konusmalarini genel baglantilarla paylasin.
---

openbmw'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda openbmw:
...
openbmw, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak openbmw manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Kurulusunuzda openbmw kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
