...
Możesz również sprawdzić [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) oraz [opencode.cafe](https://opencode.cafe), społeczność agregującą ekosystem i społeczność.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Agenci w tle, wbudowane narzędzia LSP/AST/MCP, wyselekcjonowani agenci, kompatybilność z Claude Code                  |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktywny przegląd planów z wizualnymi adnotacjami i prywatnym/offline udostępnianiem                              |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Szablon do tworzenia wtyczek OpenCode                                   |
