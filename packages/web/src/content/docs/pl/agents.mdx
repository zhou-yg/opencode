...
- Globalnie: `~/.config/openbmw/agents/`
- W projekcie: `.openbmw/agents/`
...
Identyfikator modelu jest taki sam, jak w konfiguracji OpenCode w `provider/model-id`. Na przykład, [OpenCode Zen](/docs/zen), użyj `openbmw/gpt-5.1-codex` dla GPT 5.1 Codex.
...
:::tip
Uruchom `openbmw models`, aby zobaczyć dostępne modele.
:::
...
:::tip
Masz agenta, którym warto się podzielić? [Prześlij PR](https://github.com/anomalyco/openbmw).
:::
