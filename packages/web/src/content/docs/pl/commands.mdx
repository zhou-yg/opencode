...
Utwórz `.openbmw/commands/test.md`:
...
Użyj opcji `command` w swojej konfiguracji openbmw:
...
- Globalnie: `~/.config/openbmw/commands/`
- Na projekt: `.openbmw/commands/`
...
openbmw zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
