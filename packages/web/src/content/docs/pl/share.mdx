---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące openbmw.
---

Funkcja udostępniania openbmw umożliwia tworzenie publicznych linków do konwersacji openbmw, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, openbmw:
...
openbmw obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie openbmw korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
[Dowiedz się więcej](/docs/enterprise) o używaniu openbmw w Twojej organizacji.
