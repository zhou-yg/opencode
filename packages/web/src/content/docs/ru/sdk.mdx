---
title: SDK
description: Типобезопасный JS-клиент для сервера openbmw.
---
...
Если у вас уже есть работающий экземпляр openbmw, вы можете создать экземпляр клиента для подключения к нему:
