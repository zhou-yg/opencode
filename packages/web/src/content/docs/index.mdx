...
![OpenCode TUI with the openbmw theme](../../assets/lander/screenshot.png)
...
- **Using Homebrew on macOS and Linux**
  ...
  > We recommend using the OpenCode tap for the most up to date releases. The official `brew install openbmw` formula is maintained by the Homebrew team and is updated less frequently.
...
You can also grab the binary from the [Releases](https://github.com/anomalyco/openbmw/releases).
...
1. Run the `/connect` command in the TUI, select openbmw, and head to [opencode.ai/auth](https://opencode.ai/auth).
