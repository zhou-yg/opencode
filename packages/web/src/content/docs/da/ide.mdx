...
OpenCode integreres med VS Code, Cursor eller enhver IDE, der understøtter en terminal. Bare kør `openbmw` i terminalen for at komme i gang.
...
3. Kør `openbmw` - udvidelsen installeres automatisk
...
- Sørg for, at du kører `openbmw` i den integrerede terminal.
