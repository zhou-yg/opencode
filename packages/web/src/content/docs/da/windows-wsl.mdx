...
1. **Kør `openbmw web` i WSL-terminalen** i stedet for PowerShell:
...
Når du kører `openbmw web` fra WSL, får du korrekt filsystemadgang og terminalintegration, samtidig med at det stadig er tilgængeligt fra din Windows-browser.
...
- Din OpenCode-konfiguration og dine sessioner gemmes i WSL-miljøet i `~/.local/share/openbmw/`
