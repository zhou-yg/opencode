...
Her bruger vi en community-skabt CI/CD-komponent til OpenCode — [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw).
...
For flere input og use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw) for denne komponent.
