...
- **Brug af Homebrew på macOS og Linux**
  ...
  > Vi anbefaler at bruge OpenCode-tap for at få de mest opdaterede udgivelser. Den officielle `brew install openbmw`-formel vedligeholdes af Homebrew-teamet og opdateret sjældnere.
...
Du kan også få fat i binæren fra [Releases](https://github.com/anomalyco/openbmw/releases).
