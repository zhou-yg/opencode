...
:::tip[Windows-brugere]
For den bedste oplevelse skal du køre `openbmw web` fra [WSL](/docs/windows-wsl) i stedet for PowerShell. Dette sikrer korrekt filsystemadgang og terminalintegration.
:::
...
Brugernavnet er som standard `openbmw`, men kan ændres med `OPENCODE_SERVER_USERNAME`.
