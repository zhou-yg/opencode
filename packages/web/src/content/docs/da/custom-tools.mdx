...
description: Opret værktøjer, som LLM kan kalde openbmw ind.
---
...
- Lokalt ved at placere dem i biblioteket `.openbmw/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/openbmw/tools/`.
