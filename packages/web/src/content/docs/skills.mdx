...
It loads any matching `skills/*/SKILL.md` in `.openbmw/` and any matching `.claude/skills/*/SKILL.md` or `.agents/skills/*/SKILL.md` along the way.

Global definitions are also loaded from `~/.config/openbmw/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md`, and `~/.agents/skills/*/SKILL.md`.
...
Create `.openbmw/skills/git-release/SKILL.md` like this:
