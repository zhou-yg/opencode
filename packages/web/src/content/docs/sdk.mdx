---
title: SDK
description: Type-safe JS client for openbmw server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The openbmw JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control openbmw programmatically.
...
If you already have a running instance of openbmw, you can create a client instance to connect to it:
