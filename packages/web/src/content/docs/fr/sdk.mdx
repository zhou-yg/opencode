---
title: SDK
description: Client JS de type sécurisé pour le serveur openbmw.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Le SDK openbmw JS/TS fournit un client de type sécurisé pour interagir avec le serveur.
Utilisez-le pour créer des intégrations et contrôler openbmw par programme.
...
Si vous disposez déjà d'une instance en cours d'exécution de openbmw, vous pouvez créer une instance client pour vous y connecter :
