...
Ici, nous utilisons un composant CI/CD créé par la communauté pour OpenCode — [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw).
...
Pour plus d'entrées et de cas d'utilisation [consultez la doc](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw) pour ce composant.
