...
Le [model id](/docs/config/#models) dans votre configuration OpenCode utilise le format `openbmw/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `openbmw/gpt-5.5` dans votre configuration.
