...
- Configuration du projet : `.openbmw/skills/<name>/SKILL.md`
- Configuration globale : `~/.config/openbmw/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.openbmw/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.

Les définitions globales sont également chargées à partir de `~/.config/openbmw/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` et `~/.agents/skills/*/SKILL.md`.
...
Créez `.openbmw/skills/git-release/SKILL.md` comme ceci :
