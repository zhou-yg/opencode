...
這裡我們使用的是社群建立的 OpenCode CI/CD 元件 — [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw)。
...
有關更多輸入參數和使用情境，請[查看該元件的文件](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw)。
