...
- 專案設定：`.openbmw/skills/<name>/SKILL.md`
- 全域設定：`~/.config/openbmw/skills/<name>/SKILL.md`
...
在此過程中，它會載入 `.openbmw/` 中所有匹配的 `skills/*/SKILL.md`，以及匹配的 `.claude/skills/*/SKILL.md` 或 `.agents/skills/*/SKILL.md`。

全域定義也會從 `~/.config/openbmw/skills/*/SKILL.md`、`~/.claude/skills/*/SKILL.md` 和 `~/.agents/skills/*/SKILL.md` 中載入。
...
建立 `.openbmw/skills/git-release/SKILL.md`，內容如下：
