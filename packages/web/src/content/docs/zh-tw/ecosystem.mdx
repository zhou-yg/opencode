...
您還可以查看 [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) 和 [opencode.cafe](https://opencode.cafe)，這是一個聚合生態系統與社群資源的社群。
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | 背景代理、預建置的 LSP/AST/MCP 工具、精選代理，相容 Claude Code            |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | 支援視覺化標註和私有/離線分享的互動式計畫審查                              |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用於建置 OpenCode 外掛程式的範本                              |
