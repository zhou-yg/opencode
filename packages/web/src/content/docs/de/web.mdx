...
:::tip[Windows-Nutzer]
Um die beste Erfahrung zu erzielen, führen Sie `openbmw web` über [WSL](/docs/windows-wsl) und nicht über PowerShell aus. Dies gewährleistet den ordnungsgemäßen Zugriff auf das Dateisystem und die Terminalintegration.
:::
...
Der Benutzername ist standardmäßig `openbmw`, kann aber mit `OPENCODE_SERVER_USERNAME` geändert werden.
