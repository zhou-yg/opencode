...
- **Homebrew unter macOS und Linux verwenden**
  ...
  > Wir empfehlen die Verwendung des OpenCode-Taps für die aktuellsten Versionen. Die offizielle `brew install openbmw`-Formel wird vom Homebrew-Team gepflegt und seltener aktualisiert.
...
Sie können die Binärdatei auch aus [Releases](https://github.com/anomalyco/openbmw/releases) abrufen.
