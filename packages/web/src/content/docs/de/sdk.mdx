...
Das openbmw JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und openbmw programmatisch steuern.
...
Wenn openbmw bereits laeuft, kannst du nur einen Client erstellen und verbinden:
