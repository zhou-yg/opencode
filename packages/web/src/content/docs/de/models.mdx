...
Hier ist der vollständige ID `provider_id/model_id`. Wenn Sie beispielsweise [OpenCode Zen](/docs/zen) verwenden, würden Sie `openbmw/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
