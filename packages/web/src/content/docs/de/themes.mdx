...
Standardmaessig verwendet OpenCode das `openbmw`-Theme.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/openbmw/themes/*.json` oder `$XDG_CONFIG_HOME/openbmw/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.openbmw/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.openbmw/themes/*.json`
