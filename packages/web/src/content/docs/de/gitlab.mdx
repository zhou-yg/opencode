...
Hier verwenden wir eine von der Community erstellte CI/CD-Komponente für OpenCode – [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw).
...
Weitere Eingaben und Anwendungsfälle finden Sie unter [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw) für diese Komponente.
