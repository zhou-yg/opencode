...
OpenCode lässt sich in VS Code, Cursor oder jede IDE integrieren, die ein Terminal unterstützt. Führen Sie einfach `openbmw` im Terminal aus, um zu beginnen.
...
3. Führen Sie `openbmw` aus – die Erweiterung wird automatisch installiert
...
- Stellen Sie sicher, dass Sie `openbmw` im integrierten Terminal ausführen.
