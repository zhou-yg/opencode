...
- `.openbmw/plugins/` – Plugins auf Projektebene
...
**NPM-Plugins** werden beim Start automatisch mit Bun installiert. Pakete und ihre Abhängigkeiten werden in `~/.cache/openbmw/node_modules/` zwischengespeichert.
...
1. Globale Konfiguration (`~/.config/openbmw/opencode.json`)
2. Projektkonfiguration (`opencode.json`)
3. Globales Plugin-Verzeichnis (`~/.config/openbmw/plugins/`)
4. Projekt-Plugin-Verzeichnis (`.openbmw/plugins/`)
