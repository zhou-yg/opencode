...
1. **Fuehre `openbmw web` im WSL-Terminal aus**, nicht in PowerShell:
...
Wenn du `openbmw web` aus WSL startest, bleiben Dateizugriff und Terminal-Integration sauber.
...
- OpenCode-Konfiguration und Sitzungen liegen in WSL unter `~/.local/share/openbmw/`
