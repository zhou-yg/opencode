...
Sie können sich auch [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) und [opencode.cafe](https://opencode.cafe) ansehen, eine Community, die das Ökosystem und die Community zusammenfasst.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Hintergrundagenten, vorgefertigte LSP/AST/MCP-Tools, kuratierte Agenten, Claude Code-kompatibel                               |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktive Planüberprüfung mit visueller Anmerkung und private/offline-Freigabe                                              |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Vorlage zum Erstellen von OpenCode-Plugins                                   |
