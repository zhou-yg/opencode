...
![使用 openbmw 主题的 OpenCode TUI](../../../assets/lander/screenshot.png)
...
- **在 macOS 和 Linux 上使用 Homebrew**
  ...
  > 我们推荐使用 OpenCode tap 以获取最新版本。官方的 `brew install openbmw` formula 由 Homebrew 团队维护，更新频率较低。
...
你也可以从 [Releases](https://github.com/anomalyco/openbmw/releases) 页面直接下载二进制文件。
...
1. 在 TUI 中运行 `/connect` 命令，选择 openbmw，然后前往 [opencode.ai/auth](https://opencode.ai/auth)。
