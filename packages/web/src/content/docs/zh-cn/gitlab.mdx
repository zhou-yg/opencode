...
这里我们使用的是社区创建的 OpenCode CI/CD 组件 — [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw)。
...
有关更多输入参数和使用场景，请[查看该组件的文档](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw)。
