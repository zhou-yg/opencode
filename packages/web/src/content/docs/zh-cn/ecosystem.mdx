...
您还可以查看 [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) 和 [opencode.cafe](https://opencode.cafe)，这是一个聚合生态系统与社区资源的社区。
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | 后台代理、预构建的 LSP/AST/MCP 工具、精选代理，兼容 Claude Code        |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | 支持可视化标注和私有/离线分享的交互式计划审查                          |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用于构建 OpenCode 插件的模板                                  |
