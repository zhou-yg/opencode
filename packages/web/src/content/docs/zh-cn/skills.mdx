...
- 项目配置：`.openbmw/skills/<name>/SKILL.md`
- 全局配置：`~/.config/openbmw/skills/<name>/SKILL.md`
...
在此过程中，它会加载 `.openbmw/` 中所有匹配的 `skills/*/SKILL.md`，以及匹配的 `.claude/skills/*/SKILL.md` 或 `.agents/skills/*/SKILL.md`。

全局定义也会从 `~/.config/openbmw/skills/*/SKILL.md`、`~/.claude/skills/*/SKILL.md` 和 `~/.agents/skills/*/SKILL.md` 中加载。
...
创建 `.openbmw/skills/git-release/SKILL.md`，内容如下：
