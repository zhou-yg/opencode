...
1. **Ejecuta `openbmw web` en la terminal de WSL** en lugar de PowerShell:
...
Ejecutar `openbmw web` desde WSL garantiza acceso correcto al sistema de archivos e integración con la terminal, manteniéndolo accesible desde tu navegador de Windows.
...
- Tu configuración y tus sesiones de OpenCode se guardan dentro del entorno WSL en `~/.local/share/openbmw/`
