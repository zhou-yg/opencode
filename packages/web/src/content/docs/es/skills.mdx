...
- Configuración del proyecto: `.openbmw/skills/<name>/SKILL.md`
- Configuración global: `~/.config/openbmw/skills/<name>/SKILL.md`
...
Carga cualquier `skills/*/SKILL.md` coincidente en `.openbmw/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/openbmw/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.openbmw/skills/git-release/SKILL.md` así:
