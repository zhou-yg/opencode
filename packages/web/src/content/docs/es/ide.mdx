...
OpenCode se integra con VS Code, Cursor o cualquier IDE que admita un terminal. Simplemente ejecute `openbmw` en la terminal para comenzar.
...
3. Ejecute `openbmw`: la extensión se instala automáticamente
...
- Asegúrese de estar ejecutando `openbmw` en el terminal integrado.
