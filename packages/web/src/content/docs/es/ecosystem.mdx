...
También puedes consultar [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) y [opencode\.cafe](https://opencode\.cafe), una comunidad que agrega el ecosistema y la comunidad.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Agentes en segundo plano, herramientas LSP/AST/MCP prediseñadas, agentes seleccionados, compatible con Claude Code          |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisión interactiva del plan con anotaciones visuales y uso compartido privado/sin conexión                                |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Amplíe openbmw /commands a un potente sistema de orquestación con control de flujo granular                                |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Plantilla para crear complementos OpenCode                                           |
| [opencode\.nvim](https://github.com/sudo-tee/opencode\.nvim)                                 | Interfaz de Neovim para openbmw: un agente de codificación de IA basado en terminal |
