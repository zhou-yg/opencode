...
Aquí estamos utilizando un componente CI/CD creado por la comunidad para OpenCode — [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw).
...
Para obtener más entradas y casos de uso, [consulte los documentos](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw) de este componente.
