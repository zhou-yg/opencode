...
![OpenCode TUI con el tema openbmw](../../../assets/lander/screenshot.png)
...
- **Usando Homebrew en macOS y Linux**
  ...
  > Recomendamos utilizar el tap OpenCode para las versiones más actualizadas. La fórmula oficial `brew install openbmw` la mantiene el equipo Homebrew y se actualiza con menos frecuencia.
...
También puede obtener el binario desde [Versiones](https://github.com/anomalyco/openbmw/releases).
...
1. Ejecute el comando `/connect` en la TUI, seleccione openbmw y diríjase a [opencode.ai/auth](https://opencode.ai/auth).
