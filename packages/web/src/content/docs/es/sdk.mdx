---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor openbmw.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK openbmw JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar openbmw mediante programación.
...
Si ya tiene una instancia en ejecución de openbmw, puede crear una instancia de cliente para conectarse a ella:
...
const textResults = await client.find.text({
  query: { pattern: "function.*openbmw" },
})
