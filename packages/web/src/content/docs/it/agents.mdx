...
- Globale: `~/.config/openbmw/agents/`
- Per progetto: `.openbmw/agents/`
...
L'ID modello nella configurazione OpenCode usa il formato `provider/model-id`. Per esempio, se stai usando [OpenCode Zen](/docs/zen), useresti `openbmw/gpt-5.1-codex` per GPT 5.1 Codex.
...
:::tip
Esegui `openbmw models` per vedere la lista dei modelli disponibili.
:::
...
:::tip
Hai un agente che vorresti condividere? [Invia una PR](https://github.com/anomalyco/openbmw).
:::
