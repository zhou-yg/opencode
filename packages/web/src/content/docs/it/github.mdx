...
OpenCode si integra nel tuo workflow GitHub. Menziona `/openbmw` o `/oc` in un commento e OpenCode eseguira' i task dentro il runner di GitHub Actions.
...
| ----------------------------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `issue_comment`               | Commento su una issue o PR             | Menziona `/openbmw` o `/oc` nel commento. OpenCode legge il contesto e puo' creare branch, aprire PR o rispondere.       |
| `pull_request_review_comment` | Commento su specifiche righe in una PR | Menziona `/openbmw` o `/oc` durante una review. OpenCode riceve path file, numeri di riga e contesto del diff.           |
