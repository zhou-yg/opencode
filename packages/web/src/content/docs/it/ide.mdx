...
OpenCode si integra con VS Code, Cursor o qualunque IDE che supporti un terminale. Basta eseguire `openbmw` nel terminale per iniziare.
...
3. Esegui `openbmw` - l'estensione si installa automaticamente
...
- Assicurati di eseguire `openbmw` nel terminale integrato.
