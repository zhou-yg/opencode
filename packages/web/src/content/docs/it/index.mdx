...
![OpenCode TUI con il tema openbmw](../../../assets/lander/screenshot.png)
...
- **Con Homebrew su macOS e Linux**
  ...
  > Ti consigliamo di usare il tap di OpenCode per avere le release piu aggiornate. La formula ufficiale `brew install openbmw` e mantenuta dal team Homebrew e viene aggiornata meno spesso.
...
Puoi anche scaricare il binario dalle [Releases](https://github.com/anomalyco/openbmw/releases).
...
1. Esegui il comando `/connect` nella TUI, seleziona openbmw e vai su [opencode.ai/auth](https://opencode.ai/auth).
