...
description: Crea strumenti che l'LLM puo chiamare in openbmw.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di openbmw come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.openbmw/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/openbmw/tools/`.
