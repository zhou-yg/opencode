...
:::tip[Utenti Windows]
Per la migliore esperienza, esegui `openbmw web` da [WSL](/docs/windows-wsl) invece che da PowerShell. Questo garantisce accesso corretto al file system e integrazione col terminale.
:::
...
Lo username predefinito e `openbmw`, ma puo essere cambiato con `OPENCODE_SERVER_USERNAME`.
