...
Puoi anche dare un'occhiata a [awesome-openbmw](https://github.com/awesome-openbmw/awesome-openbmw) e [opencode.cafe](https://opencode.cafe), una comunità che aggrega ecosistema e community.
...
| [oh-my-openbmw](https://github.com/code-yeongyu/oh-my-openbmw)                                   | Agenti in background, tool LSP/AST/MCP predefiniti, agenti curati, compatibile con Claude Code    |
...
| [@plannotator/openbmw](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisione interattiva dei piani con annotazione visiva e condivisione privata/offline             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estende openbmw /commands in un sistema di orchestrazione con controllo di flusso granulare      |
...
| [openbmw plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin OpenCode                               |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim per openbmw: un agente di coding AI per terminale   |
