...
- Globale: `~/.config/openbmw/commands/`
- Per progetto: `.openbmw/commands/`
...
openbmw include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
