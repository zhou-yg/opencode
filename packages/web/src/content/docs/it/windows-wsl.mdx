...
1. **Esegui `openbmw web` nel terminale WSL** invece che in PowerShell:
...
Eseguire `openbmw web` da WSL garantisce accesso corretto al file system e integrazione del terminale, restando comunque accessibile dal browser Windows.
...
- Configurazione e sessioni di OpenCode sono salvate nell'ambiente WSL in `~/.local/share/openbmw/`
