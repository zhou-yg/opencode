...
Here we are using a community-created CI/CD component for OpenCode — [nagyv/gitlab-openbmw](https://gitlab.com/nagyv/gitlab-openbmw).
...
For more inputs and use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openbmw) for this component.
